...
const REVERSE_BACKENDS = Tuple{String, Function}[
    ...
    ("Enzyme", gradient_enzyme),
    ("Mooncake", gradient_mooncake),
]

# Only include Zygote for Julia <= 1.11
if VERSION <= v"1.11"
    using Zygote
