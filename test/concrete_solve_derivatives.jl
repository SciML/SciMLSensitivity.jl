...
ū0, adj = adjoint_sensitivities(_sol, Tsit5(), t=0.0:0.1:10, dg_discrete=((out, u, p, t, i)->out .= 1), abstol=1e-14, reltol=1e-14)
...
ū0,adj = adjoint_sensitivities(_sol,EulerHeun(), t=tarray, dg_discrete=((out,u,p,t,i) -> out .= 1), sensealg=BacksolveAdjoint())
