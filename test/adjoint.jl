...
_,easy_res22 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=QuadratureAdjoint(autojacvec=false,abstol=1e-14,reltol=1e-14))
_,easy_res23 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
...
_,easy_res32 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
...
_,easy_res42 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=BacksolveAdjoint(autojacvec=false))
_,easy_res43 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
...
_,easy_res5 = adjoint_sensitivities(sol,Kvaerno5(nlsolve=NLAnderson(), smooth_est=false),
                                 ...
                                 reltol=1e-10,
                                 sensealg=BacksolveAdjoint())
_,easy_res6 = adjoint_sensitivities(sol_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=InterpolatingAdjoint(checkpointing=true),
                                  checkpoints=sol.t[1:500:end])
_,easy_res62 = adjoint_sensitivities(sol_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
...
_,easy_res7 = adjoint_sensitivities(sol_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=InterpolatingAdjoint(),
                                  checkpoints=sol.t[1:500:end])
...
_,easy_res10 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                    reltol=1e-14,
                                    sensealg=InterpolatingAdjoint(autojacvec=SciMLSensitivity.ReverseDiffVJP())
                                    )
_,easy_res11 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                     reltol=1e-14,
                                     sensealg=InterpolatingAdjoint(autojacvec=SciMLSensitivity.ReverseDiffVJP(true))
                                     )
_,easy_res12 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                     reltol=1e-14,
                                     sensealg=InterpolatingAdjoint(autojacvec=SciMLSensitivity.EnzymeVJP())
                                     )
_,easy_res13 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                     reltol=1e-14,
                                     sensealg=QuadratureAdjoint(autojacvec=SciMLSensitivity.EnzymeVJP())
                                     )

adj_prob = ODEAdjointProblem(sol,QuadratureAdjoint(abstol=1e-14,reltol=1e-14,autojacvec=SciMLSensitivity.ReverseDiffVJP()),t,dg)
adj_sol = solve(adj_prob,Tsit5(),abstol=1e-14,reltol=1e-14)
integrand = AdjointSensitivityIntegrand(sol,adj_sol,QuadratureAdjoint(abstol=1e-14,reltol=1e-14,autojacvec=SciMLSensitivity.ReverseDiffVJP()))
...
_,easy_res = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                 reltol=1e-14)
_,easy_res2 = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                 reltol=1e-14,
                                 sensealg=QuadratureAdjoint(abstol=1e-14,reltol=1e-14))
@test_broken easy_res22 = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=QuadratureAdjoint(autojacvec=false,abstol=1e-14,reltol=1e-14))[1] isa AbstractArray
_,easy_res2 = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                    reltol=1e-14,
                                    sensealg=QuadratureAdjoint(abstol=1e-14,reltol=1e-14,autojacvec=ReverseDiffVJP(true)))
_,easy_res3 = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=InterpolatingAdjoint())
@test easy_res32 = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=InterpolatingAdjoint(autojacvec=false))[1] isa AbstractArray
_,easy_res4 = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=BacksolveAdjoint())
@test easy_res42 = adjoint_sensitivities(soloop,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
...
_,easy_res5 = adjoint_sensitivities(soloop,Kvaerno5(nlsolve=NLAnderson(), smooth_est=false),
                                 ...
                                 reltol=1e-10,
                                 sensealg=BacksolveAdjoint())
_,easy_res6 = adjoint_sensitivities(soloop_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=InterpolatingAdjoint(checkpointing=true),
                                  checkpoints=soloop_nodense.t[1:5:end])
@test_broken easy_res62 = adjoint_sensitivities(soloop_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=InterpolatingAdjoint(checkpointing=true,autojacvec=false),
                                   checkpoints=soloop_nodense.t[1:5:end])

_,easy_res8 = adjoint_sensitivities(soloop_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=InterpolatingAdjoint(autojacvec=SciMLSensitivity.TrackerVJP()))
_,easy_res9 = adjoint_sensitivities(soloop_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=InterpolatingAdjoint(autojacvec=SciMLSensitivity.ZygoteVJP()))
_,easy_res10 = adjoint_sensitivities(soloop_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=InterpolatingAdjoint(autojacvec=SciMLSensitivity.ReverseDiffVJP())
                                   )
_,easy_res11 = adjoint_sensitivities(soloop_nodense,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                     reltol=1e-14,
                                     sensealg=InterpolatingAdjoint(autojacvec=SciMLSensitivity.ReverseDiffVJP(true))
                                     )
...
_,easy_res8 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  ...
                                  save_everystep=false,save_start=false,
                                  sensealg=BacksolveAdjoint())
_,easy_res82 = adjoint_sensitivities(solb,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                   reltol=1e-14,
                                   save_everystep=false,save_start=false,
...
_,end_only_res = adjoint_sensitivities(sol_end,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                  reltol=1e-14,
                                  save_everystep=false,save_start=false,
                                  sensealg=BacksolveAdjoint())
...
ū0args,adjargs = adjoint_sensitivities(sol,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                        save_everystep=false, save_start=false,
                        sensealg=BacksolveAdjoint(),
                        reltol=1e-14)

ū0args2,adjargs2 = adjoint_sensitivities(sol,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                        save_everystep=false, save_start=false,
                        sensealg=InterpolatingAdjoint(),
                        reltol=1e-14)
...
adj_prob = ODEAdjointProblem(sol,QuadratureAdjoint(abstol=1e-14,reltol=1e-14,autojacvec=SciMLSensitivity.ReverseDiffVJP()),nothing,nothing,dg,g)
...
_,easy_res = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                 reltol=1e-14)
println("2")
_,easy_res2 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=InterpolatingAdjoint())
_,easy_res22 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=InterpolatingAdjoint(autojacvec=false))
println("23")
_,easy_res23 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=QuadratureAdjoint(abstol=1e-14,reltol=1e-14))
_,easy_res232 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                  reltol=1e-14,
                                  sensealg=QuadratureAdjoint(abstol=1e-14,reltol=1e-14,autojacvec=ReverseDiffVJP(false)))
_,easy_res24 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=QuadratureAdjoint(autojacvec=false,abstol=1e-14,reltol=1e-14))
println("25")
_,easy_res25 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=BacksolveAdjoint())
_,easy_res26 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=BacksolveAdjoint(autojacvec=false))
_,easy_res262 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                   reltol=1e-14,
                                   sensealg=BacksolveAdjoint(autojacvec=false,checkpointing=false))
println("27")
_,easy_res27 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                  reltol=1e-14,
                                  checkpoints=sol.t[1:500:end],
                                  sensealg=InterpolatingAdjoint(checkpointing=true))
_,easy_res28 = adjoint_sensitivities(sol,Tsit5(),dg_continuous=dg,g=g,abstol=1e-14,
                                  reltol=1e-14,
                                  checkpoints=sol.t[1:500:end],
                                  sensealg=InterpolatingAdjoint(checkpointing=true,autojacvec=false))
println("3")
...
sol = solve(prob,Tsit5(),abstol=1e-14,reltol=1e-14)
@test_nowarn _,res = adjoint_sensitivities(sol,Tsit5(),t=t,dg_discrete=dg,abstol=1e-14,
                                 reltol=1e-14)
...
@testset "Checkpointed backsolve" begin
  ...
  t = 0:0.1:tf
  _,easy_res1 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                    reltol=1e-9,
                                    sensealg=BacksolveAdjoint())
  _,easy_res2 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                    reltol=1e-9,
                                    sensealg=InterpolatingAdjoint())
  _,easy_res3 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                    reltol=1e-9,
                                    sensealg=BacksolveAdjoint(),
                                    checkpoints=sol_lorenz.t[1:10:end])
  _,easy_res4 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                    reltol=1e-9,
                                    sensealg=BacksolveAdjoint(),
                                    checkpoints=sol_lorenz.t[1:20:end])
  # cannot finish in a reasonable amount of time
  @test_skip adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                   reltol=1e-9,
                                   sensealg=BacksolveAdjoint(checkpointing=false))
  ...
  ū1,adj1 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                     reltol=1e-9,
                                     sensealg=BacksolveAdjoint())
  ū2,adj2 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                     reltol=1e-9,
                                     sensealg=InterpolatingAdjoint())
  ū3,adj3 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                     reltol=1e-9,
                                     sensealg=BacksolveAdjoint(),
                                     checkpoints=sol_lorenz.t[1:10:end])
  ū4,adj4 = adjoint_sensitivities(sol_lorenz,Tsit5(),t=t,dg_discrete=dg,abstol=1e-6,
                                     reltol=1e-9,
                                     sensealg=BacksolveAdjoint(),
                                     checkpoints=sol_lorenz.t[1:20:end])
  # cannot finish in a reasonable amount of time
  ...
  int_u0, int_p = adjoint_sensitivities(fwd_sol,Tsit5(),g=(x, params, t)->cost(x,params), sensealg=InterpolatingAdjoint())
...
@testset "Adjoint of differential algebric equations with mass matrix" begin
  ...
  @testset "Fully ranked mass matrix" begin
    ...
    _, res = adjoint_sensitivities(sol_mm,alg,t=ts,dg_discrete=dg,abstol=1e-14,reltol=1e-14,sensealg=QuadratureAdjoint())
    reference_sol = ForwardDiff.gradient(p->G(p, prob_mm, ts, sum),vec(p))
    @test res' ≈ reference_sol rtol=1e-11

    _, res_interp = adjoint_sensitivities(sol_mm,alg,t=ts,dg_discrete=dg,abstol=1e-14,reltol=1e-14,sensealg=InterpolatingAdjoint())
    @test res_interp ≈ res rtol = 1e-11
    _, res_interp2 = adjoint_sensitivities(sol_mm,alg,t=ts,dg_discrete=dg,abstol=1e-14,reltol=1e-14,sensealg=InterpolatingAdjoint(checkpointing=true),checkpoints=sol_mm.t[1:10:end])
    @test res_interp2 ≈ res rtol = 1e-11

    _, res_bs = adjoint_sensitivities(sol_mm,alg,t=ts,dg_discrete=dg,abstol=1e-14,reltol=1e-14,sensealg=BacksolveAdjoint(checkpointing=false))
    @test res_bs ≈ res rtol = 1e-11
    _, res_bs2 = adjoint_sensitivities(sol_mm,alg,t=ts,dg_discrete=dg,abstol=1e-14,reltol=1e-14,sensealg=BacksolveAdjoint(checkpointing=true),checkpoints=sol_mm.t)
  ...
  @testset "Singular mass matrix" begin
    ...
    for iip in [true, false]
      ...
      _, res = adjoint_sensitivities(sol_singular_mm,alg,t=ts,dg_discrete=dg_singular,abstol=1e-8,reltol=1e-8,sensealg=QuadratureAdjoint(),maxiters=Int(1e6))
      reference_sol = ForwardDiff.gradient(p->G(p, prob_singular_mm, ts, sol->sum(last, sol.u)), vec(p))
      @test res' ≈ reference_sol rtol = 1e-5

      _, res_interp = adjoint_sensitivities(sol_singular_mm,alg,t=ts,dg_discrete=dg_singular,abstol=1e-8,reltol=1e-8,sensealg=InterpolatingAdjoint(),maxiters=Int(1e6))
      @test res_interp ≈ res rtol = 1e-5
      _, res_interp2 = adjoint_sensitivities(sol_singular_mm,alg,t=ts,dg_discrete=dg_singular,abstol=1e-8,reltol=1e-8,sensealg=InterpolatingAdjoint(checkpointing=true),checkpoints=sol_singular_mm.t[1:10:end])
      @test res_interp2 ≈ res rtol = 1e-5

      # backsolve doesn't work
      _, res_bs = adjoint_sensitivities(sol_singular_mm,alg,t=ts,dg_discrete=dg_singular,abstol=1e-8,reltol=1e-8,sensealg=BacksolveAdjoint(checkpointing=false))
      @test_broken res_bs ≈ res rtol = 1e-5
      _, res_bs2 = adjoint_sensitivities(sol_singular_mm,alg,t=ts,dg_discrete=dg_singular,abstol=1e-8,reltol=1e-8,sensealg=BacksolveAdjoint(checkpointing=true),checkpoints=sol_singular_mm.t)
