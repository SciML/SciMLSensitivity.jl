...
@testset "noise iip tests" begin
    ...
    # ReverseDiff
    du0,
    dp = adjoint_sensitivities(sol, RandomEM(), t = Array(t), dgdu_discrete = dg!,
    ...
    # ReverseDiff
    du0,
    dp = adjoint_sensitivities(sol2, RandomEM(), t = Array(t), dgdu_discrete = dg!,
        dt = dt, adaptive = false,
