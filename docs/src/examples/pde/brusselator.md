...
@time sol_truth = ODE.solve(
    ODE.ODEProblem(pde_truth!, u0, tspan, p_tuple), ODE.FBDF(), saveat = t_points)
...
center = N_GRID ÷ 2
sol_final = ODE.solve(
    ODE.remake(prob_ude_template, p = res.u), ODE.FBDF(), saveat = t_points)
