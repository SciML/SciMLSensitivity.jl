...
import Lux, Plots, Random, Enzyme
...
res = OPT.solve(
    OPT.OptimizationProblem(OPT.OptimizationFunction(loss_n_ode, OPT.AutoEnzyme()), p_init),
...
u0 = Float32[2.0; 0.0]
res = OPT.solve(
    OPT.OptimizationProblem(OPT.OptimizationFunction(loss_n_ode2, OPT.AutoEnzyme()), p_init.p),
